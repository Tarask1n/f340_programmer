...
//   LE_ARRAY(0x0110),    // bcdUSB
   LE_ARRAY(0x0200),    // bcdUSB
   0x00,                // bDeviceClass
   0x00,                // bDeviceSubClass
   0x00,                // bDeviceProtocol
   EP0_PACKET_SIZE,     // bMaxPacketSize0
//   LE_ARRAY(0x10C4),    // idVendor
//   LE_ARRAY(0x8845),    // idProduct
   LE_ARRAY(0x0314),    // idVendor
   LE_ARRAY(0x1011),    // idProduct
...
SEGMENT_VARIABLE(OUT_EP2_DESC, const Endpoint_Descriptor, SEG_CODE) = 
{
   0x07,                // bLength
   0x05,                // bDescriptorType
...
//   LE_ARRAY(OUT_EP1_PACKET_SIZE), // MaxPacketSize
   LE_ARRAY(OUT_EP2_PACKET_SIZE), // MaxPacketSize
//   1                    // bInterval (Unused)
   5                    // bInterval (Unused)
};
...
// static SEGMENT_VARIABLE(STRING0_DESC[STRING0_LEN], const U8, SEG_CODE) = 
// {
...
// which in this case is used in place of the first two bytes
// in the string descriptor
// #define STRING2_LEN sizeof("C8051F3xx Bulk Example") * 2
