...
#define FLASH_START           0x2000   // Address of first writeable page
#define FLASH_NUM_PAGES       14       // Number of writeable pages
...
#define FLASH_PAGE_SIZE       512      // Size of flash page in bytes
#define FLASH_START           0x2000   // Address of first writeable page
#define FLASH_NUM_PAGES       47       // Number of writeable pages
